...
Para comprobar el efecto del número de contenedores sobre el rendimiento haremos un pequeño ejemplo sobre nuestra aplicación sencilla con https://httpd.apache.org/docs/2.4/programs/ab.html[Apache Benchmark]

Número de peticiones atendidas por segundo según número de réplicas (1, 2, 4, 6, 8) y número de nodos (1, 2) (Test hecho con 10.000 peticiones y nivel de concurrencia 100)

[width="100%",options="header,footer"]
|====================
|   | 1      | 2      | 4      | 6      | 8
| 1 | 120.12 | 204.56 | 169.45 | 267.07 | 181.60  
| 2 | 119.67 | 111.89 | 247.42 | 377.78 | 534.55 
|====================
